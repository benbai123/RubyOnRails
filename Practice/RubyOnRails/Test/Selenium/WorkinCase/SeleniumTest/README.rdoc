...
For more detail with respect to Visual Testing, please refer to
Detail_of_Visual_Testing[https://github.com/benbai123/RubyOnRails/tree/master/Practice/RubyOnRails/Test/Selenium/WorkinCase/SeleniumTest#detail-of-visual-testing]
