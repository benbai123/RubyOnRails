...
From Jenkins dashboard, click New Project, select free style project and fill the fields as described in Jenkins_Job_Settings[https://github.com/benbai123/RubyOnRails/tree/master/Practice/RubyOnRails/Test/Selenium/WorkinCase/SeleniumTest#jenkins-job-settings]

==== Run it by Jenkins

From Project page, click Build with parameters and fill parameters as needed then run it.
