...
The short vidwo below shows how to start server on windows and test it remotely (assume you already installed Github_Desktop[https://desktop.github.com/] or something else and has shell to use):
