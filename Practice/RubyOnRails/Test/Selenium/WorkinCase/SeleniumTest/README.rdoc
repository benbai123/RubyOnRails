...
There is a hidden parameter "autoretest", the failed test case will re-run automatically and output filtered error message only if you specified it to any value.
