...
The short vidwo below shows how to start Selenium Standalone Server on windows and test it remotely (assume you already installed {Github Desktop}[https://desktop.github.com/] or something else and has git-shell to use):
