...
(Assume you already installed JDK/JRE like JDK7[http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html] to execute .jar file, also assume you have installed {Github Desktop}[https://desktop.github.com/] or something else and has git-shell to use)
